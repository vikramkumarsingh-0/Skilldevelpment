         ...
         <div class="banner-item">
           <div class="banner-view">
             <div class="banner-info">
               ...
               <a href="./signup/register.php" class="btn btn-primary theme-button mr-3">Become a Skillfull</a>
               <a href="./layout/services.php" class="btn btn-outline-primary theme-button">Courses</a>
             </div>
           </div>
         </div>
       </div>
  ...
  <div class="new-block py-5">
    <div class="container py-lg-3">
      <div class="header-section text-center">
        <h3>How we Teach?</h3>
        <p class="mt-3 mb-5">We innovate, teach and deliver</p>
        <a href="signup/register.php" class="btn btn-primary theme-button">Join our Community</a>
      </div>
          ...
          <div class="col-md-6">
            <div class="feature-16-gd">
              ...
              <div class="feature-16-gd-info">
                ...
                <a href="services.php" class="btn btn-primary theme-button mt-4">Learn more</a>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="middle-section">
        ...
        <div class="link-list-menu">
            ...
            <a href="/layout/about.php" class="btn btn-outline-light btn-more">About Us</a>
        </div>
      </div>
    </div>
  </div>
