...
function view_lang(){
  ...
  while($row=$get_lang->fetch()):
    echo"<tr>
            ...
            <td>".$row['lang_name']."</td>
            <td>
                <a href='index.php?lang&edit_lang='".$row['lang_id']."' title='Edit'><i class='fa-solid fa-pen-to-square'></i></a>
  ...
  function view_cat(){
    ...
    while($row=$get_cat->fetch()):
      echo"<tr>
              ...
              <td>".$row['cat_name']."</td>
              <td>
                <a href='index.php?sub_cat&edit_sub_cat=".$row['sub_cat_id']."' title='Edit'><i class='fa-solid fa-pen-to-square'></i></a>
  ...
  function edit_term(){
    ...
    if (isset($_GET['edit_term'])){
        ...
        if(isset($_POST['edit_t'])){
          $cat_name=$_POST['sub_term'];
          $cat_id=$_POST['for_whome'];

          $up=$con->prepare("update term set term='$cat_name' for_whome='$id' where t_id='$id'");
          if($up->execute()) {
  ...
  function view_term(){
    ...
    while($row=$get_c->fetch()):
      echo"<tr>
              ...
              <td>".$row['for_whome']."</td>
              <td>
                <a href='index.php?terms&edit_term=".$row['t_id']."' title='Edit'><i class='fa-solid fa-pen-to-square'></i></a>
  ...
  function contact(){
    ...
    <table>
     ...
     <tr>
         ...
         <td>http://linkdin.com/</td>
         <td><input type='text' value='".$row['linkdin']."' name='linkdin'></td>
     </tr>
 ...
 if(isset($_POST['up_con'])){
  ...
  $up=$con->prepare("update contact set phn='$phn',email='$email',add1='$add1',add2='$add2',yt='$yt',fb='$fb',insta='$insta',tw='$tw',linkdin='$linkdin'");
  if($up->execute()){
 ...
 function view_faqs(){
  ...
  function about(){
    ...
    $about->setFatchMode(PDO:: FETCH_ASSOC);
    $about->execute();
    $row=$about->fetch();
